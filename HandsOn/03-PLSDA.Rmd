...
```{r plsda-pca, fig.cap='(ref:plsda-pca)'}
...
```{r plsda-perf, fig.cap='(ref:plsda-perf)'}
...
```{r plsda-indiv12, echo = TRUE, results = 'hide', fig.show = 'hide', fig.path = 'Figures/PLSDA/'}
...
```{r plsda-indiv13, echo = TRUE, results = 'hide', fig.show = 'hide', fig.path = 'Figures/PLSDA/'}
plotIndiv(final.plsda.srbct, ind.names = FALSE, legend=TRUE,
...
```{r plsda-plotindiv, fig.cap='(ref:plsda-plotindiv)', echo=FALSE, eval=TRUE, fig.align='center', out.width = '50%', fig.height=4, fig.ncol = 2, fig.subcap=c('', '')}
...
```{r plsda-background-max, echo = TRUE, results = 'hide', fig.show = 'hide', fig.path = 'Figures/PLSDA/'}
...
```{r plsda-background-cent, echo = FALSE, results = 'hide', fig.show = 'hide', fig.path = 'Figures/PLSDA/'}
...
```{r plsda-background-mah, echo = FALSE, results = 'hide', fig.show = 'hide', fig.path = 'Figures/PLSDA/'}
...
```{r plsda-background, fig.cap='(ref:plsda-background)', echo=FALSE, eval=TRUE, fig.cap='(ref:plsda-background)', fig.align='center', out.width = '30%', fig.height=4, fig.ncol = 3, fig.subcap=c('', '', '')}
...
```{r splsda-tune, fig.cap='(ref:splsda-tune)'}
...
```{r splsda-stability, fig.cap='(ref:splsda-stability)', results='hold', fig.show='hold'}
par(mfrow=c(1,2))
# For component 1
...
```{r splsda-indiv12, echo = TRUE, results = 'hide', fig.show = 'hide', fig.path = 'Figures/PLSDA/'}
...
```{r splsda-indiv23, echo = TRUE, results = 'hide', fig.show = 'hide', fig.path = 'Figures/PLSDA/'}
...
```{r splsda-indiv, fig.cap='(ref:splsda-indiv)', echo=FALSE, eval=TRUE, fig.cap='(ref:splsda-indiv)', fig.align='center', out.width = '50%', fig.height=4, fig.ncol = 2, fig.subcap=c('(a)', '(b)')}
...
```{r splsda-var, fig.cap='(ref:splsda-var)'}
...
```{r splsda-plotloading, fig.cap='(ref:splsda-plotloading)'}
...
```{r splsda-cim, fig.width=10, fig.height=8, fig.cap='(ref:splsda-cim)'}
...
```{r splsda-roc, fig.cap='(ref:splsda-roc)', results='hold'}
