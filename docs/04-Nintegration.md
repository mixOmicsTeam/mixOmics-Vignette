...
\caption{(ref:plot-diablo)}(\#fig:plot-diablo)
\end{figure}
...
\caption{(ref:diablo-plotindiv)}(\#fig:diablo-plotindiv)
\end{figure}
...
\caption{(ref:diablo-plotarrow)}(\#fig:diablo-plotarrow)
\end{figure}
...
\caption{(ref:diablo-plotvar)}(\#fig:diablo-plotvar)
\end{figure}
...
\caption{(ref:diablo-circos)}(\#fig:diablo-circos)
\end{figure}
...
network(diablo.tcga, blocks = c(1,2,3), 
        ...
        save = 'pdf', name.save = 'diablo-network'
        )
```
...
\caption{(ref:diablo-network)}(\#fig:diablo-network)
\end{figure}
...
\caption{(ref:diablo-loading)}(\#fig:diablo-loading)
\end{figure}
...
\caption{(ref:diablo-cim)}(\#fig:diablo-cim)
\end{figure}
...
\caption{(ref:diablo-auroc)}(\#fig:diablo-auroc)
\end{figure}
